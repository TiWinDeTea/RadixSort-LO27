...
\chapter{Algorithms} \label{chapter:Algorithms}
	...
	The \texit{BaseNIntegerList} library implements a doubly linked list structure, with management functions as well.\\
	...
	\section{BaseNIntegerListOfList}
		The \texit{BaseNIntegerListOfList} library implements a structure, with management functions as well.\\
