	...
	\section{Usefull functions}
		\begin{itemize}
			...
			\item{}\textit{GetNumberWithinRange}
				\begin{itemize}
					\item{} Waits for the user to input a number within a given range. If the user inputs a number out of the asked range, the input is voided 
				\end{itemize}and to be repeated
			\item{}\textit{GetList}
				\begin{itemize}
